...
namespace _Game._Abstracts
{
    ...
    /// Inherits from IDamageable and IDamager to manage health, damage, and attack functionalities.
    /// </summary>
    public abstract class AbstractDamageableDamagerBase : MonoBehaviour, IDamageable, IDamager
    {
